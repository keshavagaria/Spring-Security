...
<head>
	...
	<title>Inspiria Technical Hub</title>
...
<body>
 	<div class="generic-container">
		...
		<div class="well lead">Inspiria Technical Hub Registration</div>
	 	<form:form method="POST" modelAttribute="user" class="form-horizontal">
			...
			<div class="row">
				...
				<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="contactNumber">Contact Number</label>
					<div class="col-md-7">
						<form:input type="text" path="contactNumber" id="contactNumber" class="form-control input-sm" />
						<div class="has-error">
